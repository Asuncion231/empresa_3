...
<div class="col-sm-12 col-md-12 col-lg-6">
  ...
  <input type="text" class="form-control text-primary text-opacity-75 fw-semibold" id="amaterno" name="amaterno" required value="<?php echo $getData['amaterno'];?>">
    ...
    <div class="mb-3">
      <div class="input-group has-validation">
       <span class="input-group-text">&#x1F512;</span> 
        <input type="pass" class="form-control text-primary text-opacity-75 fw-semibold" id="pass" name="pass" value="" required pattern="(?=.*\d)(?=.*[a-z]) (?=.*[A-Z]).{8,}" title="Debe contener al menos un número y una letra mayuscula y minuscula, y al menos 8 o mas caracteres">
      </div>
    </div>
<center>
     <td class="bg-light">
