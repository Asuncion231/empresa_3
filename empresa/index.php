...
if(isset($_POST['submit'])){
  ...
  if($nombre==''|| $cantidad==''|| $precio==''|| $id_categoria=='' || $id_proveedor=='' || $id_categoria==''|| $id_proveedor==''){
...
<div class="col-sm-12 col-md-12 col-lg-6">
  <h2 class="display-5 fw-semibold text-uppercase text-center">FORMULARIO DE REGISTRO PRODUCTO</h2>
 ...
 <div class="mb-3 mt-0">
      <label class="mb-1">Seleccionar Categoria</label>
